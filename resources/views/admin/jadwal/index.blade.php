                                            ...
                                            @forelse($skripsi as $item)
                                                @php
                                                    ...
                                                    $waktu = $jadwal
                                                        ...
                                                        : '-';
                                                    $penguji = [];
                                                    $penguji[] = $item->dosen_pembimbing;

                                                    if ($jadwal && $jadwal->dosen_penguji_2) {
                                                        $penguji[] = $jadwal->dosen_penguji_2;
                                                    }

                                                    if ($jadwal && $jadwal->dosen_penguji_3) {
                                                        $penguji[] = $jadwal->dosen_penguji_3;
                                                    }
                                                @endphp
                                                <tr>
                                                    ...
                                                    <td class="align-middle">{{ $item->narasumber }}</td>
                                                    ...
                                                    <td class="align-middle">
                                                        @if ($jadwal)
                                                            <a href="{{ route('admin.jadwal.skripsi.edit', $jadwal->id) }}"
                                                                class="btn btn-sm btn-info">Edit</a>
                                                            <form
                                                                action="{{ route('admin.jadwal.skripsi.destroy', $jadwal->id) }}"
                                                        ...
                                                        @else
                                                            <a href="{{ route('admin.jadwal.skripsi.create', $item->id) }}"
                                                                class="btn btn-sm btn-primary">Buat Jadwal</a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                                                    <td colspan="10" class="text-center">Belum ada mahasiswa yang layak
                                                        sidang</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                        ...
                                        <tbody>
                                            @forelse($metodologi as $item)
                                                @php
                                                    ...
                                                    $penguji = [];
                                                    if ($jadwal) {
                                                        if ($jadwal->dosen_penguji_1) {
                                                            $penguji[] = $jadwal->dosen_penguji_1;
                                                        }
                                                        if ($jadwal->dosen_penguji_2) {
                                                            $penguji[] = $jadwal->dosen_penguji_2;
                                                        }
                                                    }
                                                @endphp
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        @if ($jadwal)
                                                            <a href="{{ route('admin.jadwal.metodologi.edit', $jadwal->id) }}"
                                                                class="btn btn-sm btn-info">Edit</a>
                                                            <form
                                                                action="{{ route('admin.jadwal.metodologi.destroy', $jadwal->id) }}"
                                                                method="POST" class="d-inline">
                                                                @csrf @method('DELETE')
                                                                <button type="submit" class="btn btn-sm btn-danger"
                                                                    onclick="return confirm('Hapus jadwal?')">Hapus</button>
                                                        ...
                                                        @else
                                                            <a href="{{ route('admin.jadwal.metodologi.create', $item->id) }}"
                                                                class="btn btn-sm btn-primary">Buat Jadwal</a>
                                                        @endif
                                                    </td>
                                                </tr>
