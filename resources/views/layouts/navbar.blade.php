                ...
                <ul class="dropdown-menu dropdown-menu-end notification-dropdown">
                    <li class="dropdown-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="#" class="small">Tandai semua</a>
                        </div>
                    </li>
                    ...
                    <li>
                        <a class="dropdown-item notification-item" href="#">
                            ...
                            <div class="notification-content">
                                ...
                                <div class="notification-text">Mahasiswa baru mendaftar sidang skripsi</div>
                    ...
                    <li>
                        <a class="dropdown-item notification-item" href="#">
                            ...
                            <div class="notification-content">
                                <div class="notification-title">Review selesai</div>
                                <div class="notification-text">Pendaftaran telah direview</div>
                    ...
                    <li>
                        <a class="dropdown-item notification-item" href="#">
                            ...
                            <div class="notification-content">
                                <div class="notification-title">Perlu revisi</div>
                                <div class="notification-text">Dokumen perlu diperbaiki</div>
                    ...
                    <li class="dropdown-footer">
                        <a href="#" class="text-center d-block">Lihat semua notifikasi</a>
                    </li>
                </ul>
            </div>
