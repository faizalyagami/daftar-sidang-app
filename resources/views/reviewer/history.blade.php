...
@section('content')
    <div class="container-fluid">
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('reviewer.history') }}" class="row g-3 align-items-end">
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('reviewer.history') }}" class="btn btn-secondary btn-sm">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($item->academicPeriod)
                                                                @php
                                                                    $badgeClass =
                                                                        $item->academicPeriod->semester == 'Ganjil'
                                                                            ? 'bg-primary'
                                                                            : 'bg-info';
                                                                @endphp
                                                                <span class="badge {{ $badgeClass }}">
                                                                    {{ $item->academicPeriod->semester }}
                                                                    {{ $item->academicPeriod->tahun_akademik }}
                                                                </span>
                                                            @else
