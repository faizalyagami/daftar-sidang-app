            ...
            <div class="card-body">
                ...
                <form action="{{ route('dosen.penilaian.store', $penilaian->id) }}" method="POST">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="number" name="nilai_fenomena"
                                            class="form-control nilai-input {{ isset($isReadOnly) && $isReadOnly ? 'readonly-mode' : '' }}"
                                            value="{{ old('nilai_fenomena', $penilaian->nilai_fenomena) }}" min="0"
                                            max="100"
                                            {{ isset($isReadOnly) && $isReadOnly ? 'readonly disabled' : 'required' }}>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">2</td>
                                    <td class="text-center">
                                        <input type="number" name="nilai_variabel"
                                            class="form-control nilai-input {{ isset($isReadOnly) && $isReadOnly ? 'readonly-mode' : '' }}"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">2</td>
                                    <td class="text-center">
                                        <input type="number" name="nilai_teori_metode"
                                            class="form-control nilai-input {{ isset($isReadOnly) && $isReadOnly ? 'readonly-mode' : '' }}"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="number" name="nilai_alat_ukur"
                                            class="form-control nilai-input {{ isset($isReadOnly) && $isReadOnly ? 'readonly-mode' : '' }}"
                                            value="{{ old('nilai_alat_ukur', $penilaian->nilai_alat_ukur) }}"
                                            min="0" max="100"
                                            {{ isset($isReadOnly) && $isReadOnly ? 'readonly disabled' : 'required' }}>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">1</td>
                                    <td class="text-center">
                                        <input type="number" name="nilai_analisis"
                                            class="form-control nilai-input {{ isset($isReadOnly) && $isReadOnly ? 'readonly-mode' : '' }}"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">1</td>
                                    <td class="text-center">
                                        <input type="number" name="nilai_simpulan_saran"
                                            class="form-control nilai-input {{ isset($isReadOnly) && $isReadOnly ? 'readonly-mode' : '' }}"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">1</td>
                                    <td class="text-center">
                                        <input type="number" name="nilai_presentasi"
                                            class="form-control nilai-input {{ isset($isReadOnly) && $isReadOnly ? 'readonly-mode' : '' }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="catatan" class="form-control {{ isset($isReadOnly) && $isReadOnly ? 'readonly-mode' : '' }}"
                            rows="3" {{ isset($isReadOnly) && $isReadOnly ? 'readonly disabled' : '' }}>{{ old('catatan', $penilaian->catatan) }}</textarea>
                    </div>
